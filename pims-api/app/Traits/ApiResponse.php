...
trait ApiResponse
{
    ...
    protected function validationErrorResponse($errors, $message = "Validation errors occurred")
    {
        return response()->json([
            'success' => false,
            'message' => $message,
     ...
     * @return array
     */
    protected function paginatedResponse(string $resource, LengthAwarePaginator $collection): array
    {

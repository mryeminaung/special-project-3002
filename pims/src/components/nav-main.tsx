						...
						<NavLink
							...
							className={({ isActive }) =>
								[
									...
									isActive
										? "bg-primary-100 dark:bg-primary-900/60 text-primary-800 dark:text-primary-300 hover:bg-primary-100 dark:hover:bg-primary-900/70 border-l-4 border-l-primary-700 dark:border-l-primary-400 font-semibold shadow-sm"

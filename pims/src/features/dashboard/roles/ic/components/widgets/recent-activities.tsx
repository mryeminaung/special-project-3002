...
const defaultActivities: ActivityItem[] = [
	{
		id: 1,
		icon: "FileText",
		description: 'New proposal "AI Attendance System" submitted by Aung Myo Thu',
...
const typeColors: Record<string, string> = {
	...
	student: "bg-emerald-100 text-emerald-600 dark:bg-emerald-950 dark:text-emerald-400",
			...
			<CardContent className="p-0 px-5 pb-5">
				<div className="relative max-h-72 overflow-y-auto">
					...
					<div className="space-y-4">
						{data.map((activity) => {
							const IconComponent = iconMap[activity.icon] || IconFileText;
							return (

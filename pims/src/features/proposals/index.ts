...
export { default as ProposalsTable } from "./components/proposals-table";
export { ProjectAreaSelection } from "./components/project-area-selection";
export { ProjectTypeSelection } from "./components/project-type-selection";

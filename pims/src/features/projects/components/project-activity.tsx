...
export default function ProjectActivity({ project }: ProjectActivityProps) {
	...
	const midReportCompleted = project?.midReport === "submitted";
	const finalReportCompleted = project?.finalReport === "submitted";
	const midSeminarCompleted = project?.midSeminar === "completed";
	const finalSeminarCompleted = project?.finalSeminar === "completed";

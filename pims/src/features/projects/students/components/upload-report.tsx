...
export function UploadReport({
	...
	const [recentUploadedReportUrl, setRecentUploadedReportUrl] = useState<
		string | null
	>(null);
	const effectiveExistingReportUrl =
		existingReportUrl || recentUploadedReportUrl;
	const hasExistingReport =
		Boolean(effectiveExistingReportUrl) && !isExistingReportDeleted;
	...
	useEffect(() => {
		if (existingReportUrl) {
			setIsExistingReportDeleted(false);
			setRecentUploadedReportUrl(null);
		}
	}, [existingReportUrl]);
							...
							<div className="flex items-center space-x-3 overflow-hidden">
								...
								<div className="flex flex-col overflow-hidden">
									<span className="text-sm font-medium truncate max-w-45">
										{getFileNameFromUrl(effectiveExistingReportUrl ?? "")}
									</span>
